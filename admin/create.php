...
<body>
    ...
    <div class="container">
        ...
        <form id="form-send">
            ...
            <label>Marca:</label>
            <input type="text" name="marca" id="marca" class="form-control margen">
            <label>Modelo</label>
            <input type="text" name="modelo" id="modelo" class="form-control margen">
            <label>Ano Fabrico</label>
            <input type="text" name="ano" id="ano" class="form-control margen">
            <label>Km:</label>
            <input type="text" name="km" id="km" class="form-control margen">
            <label>Preco</label>
            <input type="text" name="valor" id="valor" class="form-control margen">
            <label>Combustivel</label>
            <input type="text" name="combustivel" id="combustivel" class="form-control margen">
            <label>Cor</label>
            <input type="text" name="car" id="cor" class="form-control margen">
